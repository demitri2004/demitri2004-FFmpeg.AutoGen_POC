...
public sealed unsafe class H264VideoStreamEncoder : IDisposable
{
    ...
    public H264VideoStreamEncoder(Stream stream, int fps, Size frameSize)
    {
        ...
        //ultrafast: Fastest encoding but largest file size and lowest compression.
        //superfast: Slightly slower but better compression than ultrafast.
        //fast: A good trade - off between speed and compression efficiency.
        //medium: Default setting, balanced between speed and quality.
        //veryslow: Slowest encoding but highest compression and quality.
